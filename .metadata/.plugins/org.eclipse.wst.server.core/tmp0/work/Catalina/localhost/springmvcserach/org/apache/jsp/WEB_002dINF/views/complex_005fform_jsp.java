 ...
 * Generated at: 2022-08-15 07:44:40 UTC
...
public final class complex_005fform_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/lib/spring-webmvc-5.2.4.RELEASE.jar", Long.valueOf(1658934038190L));
    _jspx_dependants.put("jar:file:/C:/Spring-Workspace/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/springmvcserach/WEB-INF/lib/spring-webmvc-5.2.4.RELEASE.jar!/META-INF/spring-form.tld", Long.valueOf(1582628626000L));
  }
...
return;
    ...
    try {
      ...
      // /WEB-INF/views/complex_form.jsp(27,5) name = path type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t<form action=\"handleform\" method=\"post\" class=\"ml-3\">\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"\">Select Type</label> <select name=\"type\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"address.street\" type=\"text\" class=\"form-control\"\r\n");
